...
public class DataSourceConfig {
    ...
    private DataSource buildDataSource() throws SQLException {
        ...
        ShardingRule shardingRule = ShardingRule.builder()
                ...
                .databaseShardingStrategy(new DatabaseShardingStrategy("id", (SingleKeyDatabaseShardingAlgorithm<?>) databaseShardingAlgorithm))
                .tableShardingStrategy(new TableShardingStrategy("type", (SingleKeyTableShardingAlgorithm<?>) tableShardingAlgorithm)).build();
